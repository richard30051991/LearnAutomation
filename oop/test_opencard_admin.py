from oop.pages.page_admin_home_page import PageHomeAdmin
from oop.pages.page_admin_add_product import PageAddProduct
from oop.pages.page_autorization import PageAuthorizationAdmin
